...
public class Main{
    public static void main(String[] args){
        ...
        player.setName(x);
        System.out.println("welcome " + player.getName() + "!\nGame start! You have" + player.getLives() + "to begin.\n");
    ...
    if(choice1.equals("A") || choice1.equals("a") || choice1.equals("C") || choice1.equals("c") || choice2.equals("A") || choice2.equals("a") || choice2.equals("B") || choice2.equals("b") || choice2.equals("C") || choice2.equals("c") || choice3.equals("B") || choice3.equals("b") || choice3.equals("C") || choice3.equals("c")){
        System.out.println("You serve the customer the ice cream, but he gives you a weird look.\nCustomer 1: Are you serious?! Why can't any of you newbies get it right?! I'm not supporting a business that hires incompetent fools like you!");
        player.loseLife();
        ...
        System.out.println("You serve the customer the ice cream. He is shocked ");
    }
